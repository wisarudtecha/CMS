// /src/components/builder/v02/FlowEditor.tsx
/**
 ...
 * Last Updated: [26-06-2025] v0.2.0
 * 
 * @notes
...
const threeLayerBreadcrumb = [
  { label: "Home", href: "/" },
  // { label: "Workflows v0.2.0", href: "/workflows/v02" },
  { label: "Workflow Builder for Case Management System" },
];
...
const WorkflowVisualEditorV02: React.FC<WorkflowEditorProps> = ({ 
  initialData = {
    nodes: [],
    connections: [],
    metadata: {
  ...
  return (
    <>
      <PageMeta
        title="React.js Workflow Builder for Case Management System | TailAdmin - Next.js Admin Dashboard Template"
        description="This is React.js Workflow Builder for Case Management System page for TailAdmin - React.js Tailwind CSS Admin Dashboard Template"
      />
        ...
        >
          ...
          <div className="mb-4 border-t border-gray-200 dark:border-gray-700 pt-4">
            ...
            <div className="bg-blue-50 dark:bg-blue-900 p-3 rounded-lg border border-blue-200 dark:border-blue-800">
              <h4 className="text-sm font-medium text-blue-800 dark:text-blue-100 mb-2">Case Summary</h4>
        ...
        >
          ...
          <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="text-xs text-gray-600 dark:text-gray-300 space-y-1">
              ...
              {(workflowMetadata.casePriority || workflowMetadata.caseCategory || workflowMetadata.targetCaseStatus) && (
                <>
...
export default WorkflowVisualEditorV02;
