    ...
    <div className="fixed inset-0 bg-gray-400/50 bg-opacity-50 flex items-center justify-center z-999999 backdrop-blur-[32px]">
      <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 max-w-sm w-full mx-4">
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{t("auth.signin.state.session_timeout.title")}</h3>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            {t("auth.signin.state.session_timeout.subtitle")} {timeLeft} {t("auth.signin.state.session_timeout.description")}
          </p>
