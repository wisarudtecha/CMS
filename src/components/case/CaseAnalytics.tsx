// /src/components/case/CaseAnalytics.tsx
import React from "react";
import type { EnhancedCaseType, TypeAnalytics } from "@/types/case";

const CaseAnalyticsContent: React.FC<{
...
export default CaseAnalyticsContent;
