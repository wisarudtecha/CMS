...
import AreaAnalyticContent from "@/components/admin/system-configuration/area/v1/AreaAnalytic";
import AreaResponseContent from "@/components/admin/system-configuration/area/v1/AreaResponse";
import AreaDesignerContent from "@/components/admin/system-configuration/area/v1/AreaDesigner";
import AreaCoverageContent from "@/components/admin/system-configuration/area/v1/AreaCoverage";
import AreaOverviewContent from "@/components/admin/system-configuration/area/v1/AreaOverview";
